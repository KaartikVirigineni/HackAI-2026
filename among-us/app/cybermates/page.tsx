      ...
      <div className="w-screen h-screen bg-cyber-dark text-cyber-green font-orbitron flex flex-col items-center justify-center z-50 absolute inset-0">
        ...
        <div className="flex gap-4 mt-8">
           {socket?.id === hostId && (
              <button 
                onClick={() => {
                   // Clear local state immediately for the host
                   setGameOver(null);
                   setGameStatus('lobby');
                   setIsTasking(false);
                   setMeetingState(null);
                ...
                className="z-50 bg-cyber-dark border border-cyber-blue px-8 py-3 rounded hover:bg-cyber-darker text-cyber-blue transition-all box-glow-blue font-bold text-xl cursor-pointer"
              >
                PLAY AGAIN (HOST)
              </button>
           )}
           <button onClick={() => {
               ...
               setIsTasking(false);
               setMeetingState(null);
           }} className="z-50 bg-cyber-dark border border-cyber-green px-8 py-3 rounded hover:bg-cyber-darker text-cyber-green transition-all box-glow-green font-bold text-xl cursor-pointer">
               RETURN TO LOBBY
           </button>
        </div>
      </div>
